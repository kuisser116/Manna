            ...
            <div className={styles.container}>
                ...
                >
                    <section className={styles.section}>
                        ...
                        <p>
                            Al registrarte en Manná, tu monedero custodial recibirá un fondeo inicial. El usuario comprende y
                    ...
                    <section className={styles.section}>
                        ...
                        <p>
                            Manná se reserva el derecho unilateral e inapelable de suspender, limitar o eliminar
                        ...
                        <p className={styles.highlight}>
                            <strong>En caso de suspensión definitiva por violación a estas normas, el usuario acepta de manera irrevocable que el depósito de confianza inicial y los balances asociados a actividades ilícitas serán retenidos y redirigidos en su totalidad al "Fondo Regional" (fondo de donaciones sociales de Manná), como medida de reparación a la red.</strong>
                        </p>
                    </section>
                    ...
                    <section className={styles.section}>
                        ...
                        <p>
                            Manná opera como una interfaz de software (dApp) que facilita la interacción con redes blockchain
                            descentralizadas (como Stellar e IPFS). Por consiguiente, el usuario reconoce que:
                        </p>
                        <ul>
                            <li>Manná no es una institución bancaria, fiduciaria ni proveedora de servicios financieros tradicionales.</li>
                            <li>Manná no asume responsabilidad por pérdidas derivadas de fallas, bifurcaciones (forks) o caídas en la red subyacente de Stellar.</li>
                            <li>El acceso a los fondos alojados depende de la autenticación de terceros (ej. Google). Si el usuario pierde el acceso a dicha cuenta externa, Manná carece de la capacidad técnica y legal para recuperar o reponer los activos digitales.</li>
                        </ul>
                    </section>
                    ...
                    <section className={styles.section}>
                        ...
                        <p>
                            La identidad del usuario se vincula a su proveedor de autenticación. Manná resguarda las llaves encriptadas
