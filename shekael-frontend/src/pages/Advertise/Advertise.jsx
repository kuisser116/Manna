            ...
            <div className={styles.twoCol}>
                            ...
                            <div className={styles.fieldRow}>
                                ...
                                <div className={styles.field}>
                                    ...
                                    <input id="promoCode" name="promoCode" type="text" value={formData.promoCode}
                                        onChange={handleChange} placeholder="Ej: Shekael2X1" />
                                </div>
                            </div>
                        </div>
                ...
                <aside className={styles.sidePanel}>
                    ...
                    <div className={styles.infoCard} style={{ background: '#1a1a1a', padding: '20px', borderRadius: '12px', border: '1px solid var(--color-border)' }}>
                        <h3 style={{ color: 'var(--color-primary)', marginBottom: '16px', fontSize: '1rem' }}>¿Por qué Shekael Ads?</h3>
            ...
            <header className={styles.portalHeader}>
                <div className={styles.headerLeft}>
                    ...
                    <div className={styles.brand}>
                        ...
                        <span className={styles.brandName}>Shekael <span className={styles.brandAccent}>Ads</span></span>
                    </div>
                </div>
