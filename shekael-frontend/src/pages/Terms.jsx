            ...
            <div className={styles.container}>
                ...
                >
                    <section className={styles.section}>
                        ...
                        <p>
                            Al registrarte en Shekael, tu monedero custodial recibirá un fondeo inicial. El usuario comprende y
                    ...
                    <section className={styles.section}>
                        ...
                        <p>
                            Shekael se reserva el derecho unilateral e inapelable de suspender, limitar o eliminar
                        ...
                        <p className={styles.highlight}>
                            <strong>En caso de suspensión definitiva por violación a estas normas, el usuario acepta de manera irrevocable que el depósito de confianza inicial y los balances asociados a actividades ilícitas serán retenidos y redirigidos en su totalidad al "Fondo Regional" (fondo de donaciones sociales de Shekael), como medida de reparación a la red.</strong>
                        </p>
                    </section>
                    ...
                    <section className={styles.section}>
                        ...
                        <p>
                            Shekael opera como una interfaz de software (dApp) que facilita la interacción con redes blockchain
                            descentralizadas (como Stellar e IPFS). Por consiguiente, el usuario reconoce que:
                        </p>
                        <ul>
                            <li>Shekael no es una institución bancaria, fiduciaria ni proveedora de servicios financieros tradicionales.</li>
                            <li>Shekael no asume responsabilidad por pérdidas derivadas de fallas, bifurcaciones (forks) o caídas en la red subyacente de Stellar.</li>
                            <li>El acceso a los fondos alojados depende de la autenticación de terceros (ej. Google). Si el usuario pierde el acceso a dicha cuenta externa, Shekael carece de la capacidad técnica y legal para recuperar o reponer los activos digitales.</li>
                        </ul>
                    </section>
                    ...
                    <section className={styles.section}>
                        ...
                        <p>
                            La identidad del usuario se vincula a su proveedor de autenticación. Shekael resguarda las llaves encriptadas
