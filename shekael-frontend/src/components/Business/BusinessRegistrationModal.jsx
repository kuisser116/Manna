...
import { X, ChevronLeft, ChevronRight, Check, MapPin, Upload, Store, Lock, Eye } from 'lucide-react';
import styles from './BusinessRegistrationModal.module.css';
...
export default function BusinessRegistrationModal({ onClose, onCreated }) {
          ...
          {step === 3 && (
            <div className={styles.stepContent}>
              <div className={styles.securityInfo}>
                <Lock size={20} />
                <p>Está contraseña se usará para proteger tu comercio. La necesitarás junto con tu PIN para eliminar el comercio.</p>
              </div>
              <div className={styles.field}>
